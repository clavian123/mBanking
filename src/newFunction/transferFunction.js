...
export const getTargetAccountList = (device_id) => {
    ...
    let address = "http://192.168.0.100:8080/getUserTargetAccounts";
...
export const inactiveTargetAccount = (device_id, bank_name, account_number) => {
    ...
    let address = "http://192.168.0.100:8080/inactiveTargetAccount";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address, req)
...
export const setTargetAccount = (target_account_name, target_account_number, target_bank_name) => {
    ...
    let address = "http://192.168.0.100:8080/setTargetAccount";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address, req);
...
export const getTargetAccount = () => {
    let address = "http://192.168.0.100:8080/getTargetAccount";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
...
export const getBankList = () => {
    let address = "http://192.168.0.100:8080/getExternalBanks";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address);
...
export const checkAccountExist = (account_number) => {
    ...
    let address = "http://192.168.0.100:8181/checkAccountExistFromCore";
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const setTransferSourceAccount = (source_account_number, source_account_name, source_account_balance, amount, customer_note) => {
    ...
    let address = "http://192.168.0.100:8080/setTransferSourceAccount"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const getTransferMethod = () => {
    let address = "http://192.168.0.100:8080/getTransferMethod";
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address)
...
export const setTransferMethod = (method, fee) => {
    ...
    let address = "http://192.168.0.100:8080/setTransferMethod"
    return async dispatch => {
        dispatch(setLoading(true))
        try{
            const res = await axios.post(address, req)
...
export const transferConfirmation = () => {
    let address = "http://192.168.0.100:8080/transferConfirmation"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address)
...
export const checkTargetAccountExist = (device_id) => {
    ...
    let address = "http://192.168.0.100:8080/checkTargetAccountExist"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const sendTransferOtp = (device_id) => {
    ...
    let address = "http://192.168.0.100:8080/sendTransferOTP"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const transferGetUserEmail = (device_id) => {
    ...
    let address = "http://192.168.0.100:8080/transferGetUserEmail"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const validateTransferOtp = (token) => {
    ...
    let address = "http://192.168.0.100:8080/validateTransferOTP"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const createFundTransfer = (device_id) => {
    ...
    let address = "http://192.168.0.100:8080/createFundTransfer"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
