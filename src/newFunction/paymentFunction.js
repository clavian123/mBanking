...
export const getBillPaymentMerchants = () => {
    let address = "http://192.168.0.101:8080/getBillPaymentMerchants"
...
export const setMerchantCode = (merchant_code, merchant_name) => {
    ...
    let address = "http://192.168.0.101:8080/setMerchantCode";
    return async dispatch => {
        dispatch(setLoading(true))
        try {
...
export const getUserTargetSubscribers = (device_id, merchant_code) => {
    ...
    let address = "http://192.168.0.101:8080/getUserTargetSubscribers"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const inactiveTargetSubscriber = (device_id, subscriber_number) => {
    ...
    let address = "http://192.168.0.101:8080/inactiveTargetSubscriber"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const checkSubscriberExist = (subscriber_number) => {
    ...
    let address = "http://192.168.0.101:8282/checkSubscriberExist"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const setTargetSubscriber = (subscriber_number, subscriber_name, alias) => {
    ...
    let address = "http://192.168.0.101:8080/setTargetSubscriber"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const getBilledAmount = () => {
    let address = "http://192.168.0.101:8080/getBilledAmount"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address)
...
export const setBillPaymentSourceAccount = (source_account_number, source_account_name, source_account_balance, amount) => {
    ...
    let address = "http://192.168.0.101:8080/setBillPaymentSourceAccount"
    return async dispatch => {
        dispatch(setLoading(true))
        try { 
            const res = await axios.post(address, req)
...
export const getBillPaymentConfirmation = () => {
    let address = "http://192.168.0.101:8080/getBillPaymentConfirmation"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address)
...
export const checkTargetSubscriberExist = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/checkTargetSubscriberExist"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const sendBillPaymentOtp = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/sendBillPaymentOTP"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address,req)
...
export const validateBillPaymentOtp = (token) => {
    ...
    let address = "http://192.168.0.101:8080/validateBillPaymentOTP"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const createBillPaymentTransaction = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/createBillPaymentTransaction"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
