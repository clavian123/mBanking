...
export const usernameLogin = (username, password) => {
    ...
    let address = "http://192.168.0.101:8080/usernameLogin";
...
export const sendLoginOTP = () => {
    let address = "http://192.168.0.101:8080/sendLoginOTP";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
...
export const getUserEmail = () => {
    let address = "http://192.168.0.101:8080/getUserEmail";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address);
...
export const validateLoginOTP = (token) => {
    ...
    let address = "http://192.168.0.101:8080/validateLoginOTP";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address, req);
...
export const checkUserLogin = () => {
    let address = "http://192.168.0.101:8080/checkUserLoginExist";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address);
...
export const createUserLogin = (deviceId, easyPin) => {
    ...
    let address = "http://192.168.0.101:8080/createNewUserLogin";
    return async dispatch => {
        dispatch(setLoading(true));
        try {
            const res = await axios.post(address, req);
...
export const validateEasyPinLogin = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/validateEasyPinLogin";
    return async dispatch => {
        try { 
            const res = await axios.post(address, req);
...
export const validateEasyPin = (device_id, easy_pin) => {
    ...
    let address = "http://192.168.0.101:8080/validateEasyPin"
    return async dispatch => {
        dispatch(setLoading(true))
        try {
            const res = await axios.post(address, req)
...
export const loginEasyPin = (device_id, easy_pin) => {
    ...
    let address = "http://192.168.0.101:8080/easyPinLogin";
    return async dispatch => {
        dispatch(setLoading(true));
        try{
            const res = await axios.post(address, req);
...
export const refreshEasyPinLogin = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/refreshEasyPinLogin"
    return async dispatch => {
        try {
            const res = await axios.post(address, req)
            return await res.data;
...
export const handleLogout = (device_id) => {
    ...
    let address = "http://192.168.0.101:8080/logout";
    syncLogoutToStorage();
    return dispatch => {
        dispatch(setLoading(true));
