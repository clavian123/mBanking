...
export function getStatements(cif_code) {
    ...
    let address = "http://192.168.0.105:8080/getAllAccountStatementByCustomer";
    return dispatch => {
...
export function getCustomerData(cif_code) {
    ...
    let address = "http://192.168.0.105:8080/getCustomerDummyByCifCode";
...
export function getTransactionRecommendation(cif_code){
    ...
    let address = "http://192.168.0.105:8080/getTransactionRecommendation";
