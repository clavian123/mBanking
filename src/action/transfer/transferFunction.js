...
export function getBankList(keyword) {
    ...
    let address = "http://192.168.0.100:8080/targetBank";
    return dispatch => {
...
export function checkAccountNumber(bankCode, bankId, bankName, accNumber) {
    ...
    let address = "http://192.168.0.100:8080/findAccountDummyByAccountNumber";
    return dispatch => {
...
export function getMethodList() {
    let address = "http://192.168.0.100:8080/getFundTransferTransCharge";
    return dispatch => {
...
export function getListDest(cif_code, keyword){
    ...
    let address = "http://192.168.0.100:8080/getTargetAccounts"
...
export function transfer(sourceAccNumber, destAccNumber, amount, fee, note, bankId){
    ...
    let address = "http://192.168.0.100:8080/saveNewFundTransfer"
...
export function saveNewTargetAccount(cif_code, accountNumber, bankId){
    ...
    let address = "http://192.168.0.100:8080/saveNewTargetAccount"
...
export function deleteTargetAccount(targetAccount){
    ...
    let address = "http://192.168.0.100:8080/deleteTargetAccount"
