...
export function getTargetSubscriberList(keyword, merchantCode, cif_code) {
    ...
    if(merchantCode == ""){
        ...
        address = "http://192.168.0.105:8080/getTargetSubscriber";
    }else{
        req = {
            keyword: keyword,
        ...
        address = "http://192.168.0.105:8080/getTargetSubscriberByMerchant"
    }
...
export function deleteTargetSubscriber(targetSubscriber) {
    ...
    let address = "http://192.168.0.105:8080/deleteTargetSubscriber";
...
export function checkPaymentAccountNumber(merchantCode, accNumber) {
    ...
    let address = "http://192.168.0.105:8080/findBillpaymentAccountDummyByAccountNumberAndMerchant";
...
export function getPaymentTransCharge(merchantCode, merchantName, accNumber, accName) {
    ...
    let address = "http://192.168.0.105:8080/getBillPaymentTransCharge";
...
export function saveNewTargetSubscriber(merchantCode, subscriberNumber, cif_code) {
    ...
    let address = 'http://192.168.0.105:8080/saveNewTargetSubscriber';
...
export function billPayment(customerNumber, customerName, accNumber, amount, bankCharge, merchantCode) {
    ...
    let address = "http://192.168.0.105:8080/saveNewBillpaymentTransaction";
