...
export function checkPan(pan){
    ...
    let address = "http://192.168.100.184:8080/getCustomerDummyByPAN";
    return dispatch => {
...
export function getRegisterToken(customer){
    ...
    let address = "http://192.168.100.184:8080/saveRegisterOtp";
    return dispatch => {
...
export function validateRegisterToken(customer, token){
    ...
    let address = "http://192.168.100.184:8080/validateRegisterOtp";
    return dispatch => {
...
export function validatePin(customer, pin){
    ...
    let address = "http://192.168.100.184:8080/validatePIN";
    return dispatch => {
...
export function checkCustomer(cifcode){
    ...
    let address = "http://192.168.100.184:8080/getCustomerByCifCode";
...
export function checkUsername(username){
    ...
    let address = "http://192.168.100.184:8080/checkUsername";
...
export function createNewUser(username, password, customer, status){
    ...
    let address = "http://192.168.100.184:8080/saveNewUser";
...
export function getUser(customer){
    ...
    let address = "http://192.168.100.184:8080/getUserByCustomer";
...
export function resetUserPassword(username, password){
    ...
    let address = "http://192.168.100.184:8080/resetUserPassword";
...
export function login(username, password){
    ...
    let address = "http://192.168.100.184:8080/login";
...
export function getLoginToken(cif_code){
    ...
    let address = "http://192.168.100.184:8080/saveLoginOtp";
...
export function validateLoginToken(cif_code, token){
    ...
    let address = "http://192.168.100.184:8080/validateLoginOtp";
