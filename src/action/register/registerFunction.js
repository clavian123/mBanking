...
export function checkPan(pan){
    ...
    let address = "http://192.168.0.100:8080/getCustomerDummyByPAN";
    return dispatch => {
...
export function validatePin(customer, pin){
    ...
    let address = "http://192.168.0.100:8080/validatePIN";
    return dispatch => {
...
export function checkCustomer(cifcode){
    ...
    let address = "http://192.168.0.100:8080/getCustomerByCifCode";
...
export function checkUsername(username){
    ...
    let address = "http://192.168.0.100:8080/checkUsername";
...
export function createNewUser(username, password, customer, status){
    ...
    let address = "http://192.168.0.100:8080/saveNewUser";
...
export function getUser(customer){
    ...
    let address = "http://192.168.0.100:8080/getUserByCustomer";
...
export function resetUserPassword(username, password){
    ...
    let address = "http://192.168.0.100:8080/resetUserPassword";
...
export function login(username, password){
    ...
    let address = "http://192.168.0.100:8080/login";
